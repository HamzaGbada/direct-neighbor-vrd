...
from src.utils.utils import convert_xmin_ymin
...
class WILDRECEIPT(VisionDataset):
    ...
    def __init__(self, train: bool = True, **kwargs: Any) -> None:
        ...
        for json_string in json_strings:
            ...
            _targets = [(convert_xmin_ymin(annotation['box']), annotation['text'].lower(), annotation['label']) for annotation in annotations]
