...
def build_subparser(parser):
    subparser = parser.add_subparsers(dest="subcommand", help="Choose subcommand")

    # Subparser for building
    parser_building = subparser.add_parser("build")
    return parser_building


def train_subparser(parser):
